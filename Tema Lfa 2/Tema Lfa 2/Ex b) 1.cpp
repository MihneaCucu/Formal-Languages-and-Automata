/*
    ...
    C++ implementation of Hopcroft's algorithm with equivalence classes
    representing the Myhill–Nerode equivalence relation.
    Takes a DFA transiton matrix as input. Outputs the minimised DFA matrix.
    
    Find the NFA to DFA conversion C++ implementation here:
        https://gist.github.com/armag-pro/39dfc5a0d10ab9473d7a69b8bfb38615
*/
...
ifstream fin("dfa_min.txt");
ofstream fout("dfa_minimizat.txt");
void print_min() {
    fout << "\n Minimised DFA Table:\n";
    fout << "---------------------\n";
    fout << "Q\t";
